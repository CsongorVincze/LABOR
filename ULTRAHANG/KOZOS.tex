...
\begin{figure}[h!]
    ...
    \caption{Az adó-vevő páros átviteli karakterisztikája (Széles sáv)}
...
\begin{figure}[h!]
    ...
    \caption{Rezonanciafrekvencia környezete (diagram)}
...
\begin{figure}[htp]
    ...
    \caption{Maximumhelyek (távolság) az anticsomópont sorszámának függvényében. A meredekség megadja a félhullámhosszt ($\frac{\lambda}{2} = 4{,}39$ mm).}
